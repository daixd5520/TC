...
class CRCoTGenerator:
    def __init__(self):
        ...
        self.api_configs = [
            {
                "name": "API_1",
                "api_key": "sk-uddsabfgczccnueoldoovfbwgiwjeprnngkrcpcqjyevikrx",
                "base_url": "https://api.siliconflow.cn/v1",
                "model": "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B"
            },
            {
                "name": "API_2",
                "api_key": "sk-komcylukadnsmehvjqiazjirlqtwxazgrisgezqwulhwpfsp",
                "base_url": "https://api.siliconflow.cn/v1",
                "model": "deepseek-ai/DeepSeek-R1-0528-Qwen3-8B"
            },
            {
                "name": "API_3",
                "api_key": "sk-iszaocrvhnmpaybgfakpwcedpvqnfoamltmiykpuxpsopoky",
                "base_url": "https://api.siliconflow.cn/v1",
                "model": "deepseek-ai/DeepSeek-R1-0528-Qwen3-8B"
            },
            {
                "name": "API_4",
                "api_key": "sk-bwywlfubvuqxoapqegmvimwjprnuoleruhkfjkgrjipysstk",
                "base_url": "https://api.siliconflow.cn/v1",
                "model": "deepseek-ai/DeepSeek-R1-0528-Qwen3-8B"
            },
            {
                "name": "API_5",
                "api_key": "sk-lpjdfwtiuzmeayozlyjmiklecimjfomhattgsorsdntwyznk",
                "base_url": "https://api.siliconflow.cn/v1",
                "model": "deepseek-ai/DeepSeek-R1-0528-Qwen3-8B"
            }
        ]
    ...
    def _build_system_prompt(self):
        """构建系统提示词 - 针对情感分析任务"""
        prompt = (
            "You are a sentiment analysis expert. Given a customer review text and its correct sentiment classification, "
            "your task is to provide a detailed, step-by-step reasoning process that logically leads to the correct sentiment classification. "
            "Your explanation should analyze the emotional tone, language patterns, and sentiment indicators in the text.\n\n"
    ...
    def _build_user_prompt(self, text, true_label):
        """构建用户提示词"""
        return (
            "Please provide a detailed, step-by-step reasoning process for the following sentiment analysis task:\n\n"
            f"Text: {text}\n"
            f"Correct sentiment label: {true_label}\n\n"
            f"Explain, step by step, why this text belongs to sentiment category {true_label}, following the required format."
        )
        ...
        for i, item in enumerate(batch_data):
            if (item.get('text') and item.get('text').strip() and 
                ...
                if label_text == "positive":
                    ...
                    logger.warning(f"样本 {batch_id}_{i} 未知标签: {label_text}")
                    failed_count += 1
                    continue
...
def main():
    ...
    output_file = "/mnt/data1/TC/TextClassDemo/data/CR/CR_Train_cot.json"
    checkpoint_file = "/mnt/data1/TC/TextClassDemo/data/CR/CR_Train_cot_checkpoint.json"
